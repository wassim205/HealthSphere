...
export default function WorkoutDetailsScreen({ route, navigation }: Props) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>WorkoutDetails</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '700', color: '#F0F2F7', marginBottom: 8 },
  subtitle: { fontSize: 14, color: '#7A7F8E', marginBottom: 16 },
  button: {
    height: 44,
